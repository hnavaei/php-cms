 ...
 *   https://datatables.net/download/#bs4/dt-1.11.4/b-2.2.2/date-1.1.1/fc-4.0.1/r-2.2.9
 *
 * Included libraries:
 *   DataTables 1.11.4, Buttons 2.2.2, DateTime 1.1.1, FixedColumns 4.0.1, Responsive 2.2.9
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/dt-1.11.4/b-2.2.2/date-1.1.1/fc-4.0.1/r-2.2.9",
